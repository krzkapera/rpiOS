...
#define TD_KERNEL_BLOCK_FLAGS                                                                      \
	(TD_ACCESS | TD_INNER_SHARABLE | TD_KERNEL_PERMS | (MATTR_NORMAL_NC_INDEX << 2) | TD_BLOCK |   \
	 TD_VALID)
#define TD_DEVICE_BLOCK_FLAGS                                                                      \
	(TD_ACCESS | TD_INNER_SHARABLE | TD_KERNEL_PERMS | (MATTR_DEVICE_nGnRnE_INDEX << 2) |          \
	 TD_BLOCK | TD_VALID)
#define TD_USER_TABLE_FLAGS (TD_TABLE | TD_VALID)
#define TD_USER_PAGE_FLAGS                                                                         \
	(TD_ACCESS | TD_INNER_SHARABLE | TD_USER_PERMS | (MATTR_NORMAL_NC_INDEX << 2) | TD_PAGE |      \
	 TD_VALID)
...
#define MAIR_EL1_VAL                                                                               \
	((MATTR_NORMAL_NC << (8 * MATTR_NORMAL_NC_INDEX)) | MATTR_DEVICE_nGnRnE                        \
															<< (8 * MATTR_DEVICE_nGnRnE_INDEX))
