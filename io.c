...
// unsigned int gpio_call(unsigned int pin_number, unsigned int value, unsigned int base,
...
// 	AUX_UART_CLOCK = 200000000
// };

// #define AUX_MU_BAUD(baud) ((AUX_UART_CLOCK / (baud * 8)) - 1)

// void uart_init() {
// 	mmio_write(AUX_ENABLES, 1);		// enable UART1 musi
// 	mmio_write(AUX_MU_CNTL_REG, 3); // enable rx tx
// 	mmio_write(AUX_MU_LCR_REG, 3);	// 8 bits
// 	mmio_write(AUX_MU_MCR_REG, 0);
// 	mmio_write(AUX_MU_IER_REG, 0);
// 	mmio_write(AUX_MU_IIR_REG, 6); // disable interrupts, bylo 0xC6??
...
enum { GPIO_MAX_PIN = 53, GPIO_FUNCTION_OUT = 1, GPIO_FUNCTION_ALT5 = 2, GPIO_FUNCTION_ALT3 = 7 };
